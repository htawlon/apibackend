...
class ApiController extends Controller
{
   public function newDoctor(Request $request){
       ...
       $d->save();
       return response()->json(['message'=>"The new doctors have been save"]);
   }
   public function newPatient(Request $request){
       ...
       $p->save();
       return response()->json(['message'=>'The new patient have been created.']);
   ...
   public function getPatients(){
       $pts=Patient::with('doctor')->with('category')->OrderBy('id','desc')->get();
